...
public class STSAssumeRoleExample {

	private static String userKey = "BKIAJHCO2RNVECNXPA5A";
	private static String userSecret = "sVBWkcAb9eFsMewTLzDypJGK03prq5R0Dxxam+4z";
